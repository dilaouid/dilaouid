  ...
  return () => {
    ...
    return (
        <section className="relative min-h-[85vh] w-full flex flex-col justify-center overflow-hidden">
            ...
            <div ref={particlesContainerRef} className="absolute inset-0 z-10" />

            {/* Effet de lueur */}
            <div className="absolute -top-[40%] left-[30%] w-[500px] h-[500px] rounded-full bg-primary/20 blur-[120px] -z-10" />
            <div className="absolute -bottom-[30%] right-[20%] w-[400px] h-[400px] rounded-full bg-purple-500/20 blur-[100px] -z-10" />

            <div className="container px-4 md:px-6">
                <div className="flex flex-col md:flex-row items-center gap-10">
                    {/* Section photo de profil */}
                    <motion.div
                        className="md:w-1/3 mt-20 sm:mt-8 md:mt-0 relative z-10"
                    ...
                    <div className="flex flex-col text-center md:text-left md:w-2/3">
                        <motion.div
                            ...
                            className="mt-16 md:mt-0" // Added margin-top here
                        >
